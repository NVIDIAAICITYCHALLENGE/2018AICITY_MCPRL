...
#modify the Fc layers of VGGNet for our classification work
class VGG(nn.Module):
...
#modify the FC layers of ResNet for our work
...
#choose a network for our work.
#Because our work is not difficult, VGG16 can handle it well.
